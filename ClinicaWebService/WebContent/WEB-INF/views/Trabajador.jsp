...
<!-- *****************************************************************************************+ -->
	...
	<c:if test="${!empty listaTrabajador}">
	    ...
	    <tbody class="dataServicios">
			<c:forEach items="${listaTrabajador}" var="libro">
				<tr>
					<td>${libro.TRABAJADORID}</td>
					<td>${libro.NOMBRE}</td>
					...
					<td><a href="<c:url value='/updatePerson/${libro.TRABAJADORID}' />">Edit</a>|<a href="<c:url value='/eliminarServicio/${libro.TRABAJADORID}' />">Eliminar</a></td>
  ...
  <div class="modal fade" id="myModalServicio" role="dialog">
   ...
   <form id="formRegistropac" >	
	  ...
	  <script type="text/javascript" src="<c:url value="/resources/Scripts/app/js/jquery.trabajador.js" />"></script>
	       <!-- Validaciones -->
