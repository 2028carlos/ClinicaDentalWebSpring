...
<!-- *****************************************************************************************+ -->
	...
	<c:if test="${!empty listaServicio}">
		<table class="tg" id ="tabla">
		 <thead>
			<tr>
				<th width="80">Id</th>
	    ...
	    <tbody class="dataServicios">
			<c:forEach items="${listaServicio}" var="libro">
				<tr>
					<td>${libro.servicioid}</td>
					<td>${libro.nombre}</td>
					<td>${libro.descripcion}</td>
					
					<td><a href="<c:url value='/updatePerson/${libro.servicioid}' />">Edit</a>|<a href="<c:url value='/eliminarServicio/${libro.servicioid}' />">Eliminar</a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-info" id="Enviar2"  value="enviar"/>
        </div>
      </div>
	  ...
	  <script type="text/javascript" src="<c:url value="/resources/Scripts/app/js/jquery.servicio.js" />"></script>
</body>
</html>
