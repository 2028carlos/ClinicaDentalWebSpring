...
<!-- *****************************************************************************************+ -->
	...
	<c:if test="${!empty listOfusuario}">
		<table class="tg" id="tablausuario">
			 <thead>
			<tr>
				<th width="80">Id</th>
			...
			<c:forEach items="${listOfusuario}" var="usuario">
				<tr>
					...
					<td>${usuario.ROLESID}</td>
				
					
					<td><a href="<c:url value='/updateItinerario/${usuario.USUARIOID}' />">Edit</a></td>
					<td><a href="<c:url value='/deleteItinerario/${usuario.USUARIOID}' />">Delete</a></td>
				</tr>
			</c:forEach>
			 </tbody>
		</table>
  ...
  <div class="modal fade" id="myModalServicio" role="dialog">
   ...
   <form >	
	  ...
	  <script type="text/javascript" src="<c:url value="/resources/Scripts/app/js/jquery.usuario.js" />"></script>
</body>
</html>
