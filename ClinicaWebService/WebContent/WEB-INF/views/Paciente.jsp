...
<!-- *****************************************************************************************+ -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                   ...
                   <div class="col-md-12">
                   <button class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#paciente">Nuevo</button><br /><br />  
                        
   

	<c:if test="${!empty listaPaciente}">
		<table class="tg" id ="tablaPac">
		 <thead>
			<tr>
				<th width="80">Id</th>
				<th width="120">Tipo Documento</th>
				<th width="120">Numero Documento</th>
				<th width="120">Fecha de Creacion</th>
				...
				<th width="60">Nombre</th>
					...
					<th width="60">Genero   </th>
							<th width="60">Opciones  </th>
			</tr>
	    </thead>
	    
	    <tbody class="dataServicios">
			<c:forEach items="${listaPaciente}" var="libro">
				<tr>
					<td>${libro.pacienteid}</td>
					<td>${libro.tipodocumento}</td>
					<td>${libro.numdocumento}</td>
					...
					<td><a href="<c:url value='/updatePerson/${libro.pacienteid}' />">Edit</a>|<a href="<c:url value='/eliminarServicio/${libro.pacienteid}' />">Eliminar</a></td>
  ...
  <div class="modal fade" id="paciente" role="dialog">
   ...
   <form id="formRegistropac" >	
	  ...
	  <script type="text/javascript" src="<c:url value="/resources/Scripts/app/js/jquery.pacientes.js" />"></script>
	       <!-- Validaciones -->
